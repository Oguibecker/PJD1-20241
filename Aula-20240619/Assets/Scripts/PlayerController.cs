...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    protected PlayerAmmunition AmmoPlayer;
    ...
    static protected PlayerController _instance = null;
    ...
    private void Awake()
    {
        ...
        AmmoPlayer = new PlayerAmmunition();
    ...
    protected void DetectCurrentWeapons()
    {
        ...
        foreach (var weapon in weapons)
        {
            ...
            AmmoPlayer.AddAmmo(weapon.Type, weapon.Ammo);
            AmmoPlayer.AddAmmoMax(weapon.Type, weapon.MaxAmmo);
        }
    }
    ...
    public void SetItemValue(ItemType type, float value)
    {
        Debug.Log($"{Enum.GetName(typeof(ItemType), type)} {value}");
        ...
        switch(type)
        {
            ...
            case ItemType.AmmoPistol:
                AmmoPlayer.AddAmmo(WeaponType.Pistol, (int)value);
                break;
            case ItemType.AmmoShotgun:
                AmmoPlayer.AddAmmo(WeaponType.Shotgun, (int)value);
                break;
            case ItemType.AmmoMachineGun:
                AmmoPlayer.AddAmmo(WeaponType.MachineGun, (int)value);
                break;
            case ItemType.AmmoSniper:
                AmmoPlayer.AddAmmo(WeaponType.Sniper, (int)value);
                break;
            case ItemType.AmmoRocketLauncher:
                AmmoPlayer.AddAmmo(WeaponType.RocketLauncher, (int)value);
                break;
            case ItemType.AmmoGranadeLauncher:
                AmmoPlayer.AddAmmo(WeaponType.GranadeLauncher, (int)value);
                break;
            case ItemType.AmmoLaser:
                AmmoPlayer.AddAmmo(WeaponType.Laser, (int)value);
                break;
        }
    }
}
