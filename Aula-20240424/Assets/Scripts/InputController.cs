...
public class InputController : MonoBehaviour
{
    ...
    [SerializeField]
    static public bool Alpha1Down { get; protected set; }
    [SerializeField]
    static public bool Alpha2Down { get; protected set; }
    [SerializeField]
    static public bool Alpha3Down { get; protected set; }
    [SerializeField]
    static public bool Alpha4Down { get; protected set; }
    [SerializeField]
